...
source('~/Users/taylor/sitt/sitt/R/interaction_tools.R')
...
```{r, fig.align = 'center', fig.width = 10, fig.height = 10, cache = TRUE}
...
```{r, echo=FALSE, fig.cap = "Frequency distributions of outcome vectors coded from Uniform, Normal, and Poisson distribution pseudorandom matrices.", fig.width = 12, fig.height = 20, fig.align = 'center'}
library(ggplot2)
library(dplyr)
